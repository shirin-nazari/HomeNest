...
const LatestPosts = ({ posts, limit = 3 }: LatestPostsProps) => {
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-12">
      <h2 className="2xl font-bold mb-6 text-white">Latest Posts</h2>
      <div className="grid gap-6 lg:grid-cols-2">
        <img src="/blog-latest.png" alt="latest-blog" />
        <div className="grid gap-6 lg:grid-cols-1">
          {latest.map((post) => (
            ...
            >
              <h3 className="text-lg text-semibold text-blue-400 mb-1">
                {post.title}
              </h3>
